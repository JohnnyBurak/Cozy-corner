...
Технический долг нашего проекта включает в основном неотрефакторенный код и не покрытый тестами код. Это связано с тем, что все основные усилия были положены на реализацию всего функционала веб-сайта. Так как реализован весь запланированый функционал веб-сайта, то недоимплементированных фич нет. Были  идеи реализации дополнительного функционала. Однако  время, сроки (и количство ЛР) этого не позволи сделать.
